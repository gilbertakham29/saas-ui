...
<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li class="mb-3">
                          <a href="https://discord.gg/4eeurUVvTy" class="hover:underline">Affiliates</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div class="sm:flex flex flex-col items-center justify-between sm:items-center sm:justify-between">
          ...
          <span class=" mt-3 text-sm text-gray-500 sm:text-center dark:text-gray-400">@<a href="https://flowbite.com/" class="hover:underline">Copyright</a>. All Rights Reserved.
          </span>
      </div>
    </div>
</footer>
